...
def clean_leg_main(cell_name, num_thread, replace, out_name):
    cell_name, num_thread, replace, out_name = args.cell_name, args.thread, args.replace_switch, args.out_name
    t0 = time.time()
    #read data file
